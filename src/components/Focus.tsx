      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 text-lg">
            We strategically target high-growth sectors in Albania's developing
            economy, focusing on areas with strong potential for sustainable
            returns.
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:transform hover:scale-105">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">
                ...
                opportunities in residential, commercial, and luxury properties.
              </p>
            ...
            <div className="p-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-red-600 shrink-0 mt-0.5" />
                  <span className="text-gray-700">
                    <strong>Funding High-Potential Startups:</strong> Providing
                    financial backing to innovative ideas.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-red-600 shrink-0 mt-0.5" />
                  <span className="text-gray-700">
                    <strong>Mentorship & Strategic Guidance:</strong> Connecting
                    startups with industry experts.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-red-600 shrink-0 mt-0.5" />
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700">
                    ...
                    eco-friendly solutions like solar energy, waste management,
